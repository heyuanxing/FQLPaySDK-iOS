Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/heyuanxing/FQLPaySDK-iOS.git", :tag =>"1.6.0.4"}
  ...
  s.pod_target_xcconfig = { :CLANG_CXX_LANGUAGE_STANDARD => "c++11", :CLANG_CXX_LIBRARY => "libc++", 'EXCLUDED_ARCHS[sdk=iphonesimulator*]' => 'arm64'}
