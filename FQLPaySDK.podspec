Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "8.0"
  s.source       = { :git => "https://github.com/FenqileAppTeam/FQLPaySDK-iOS.git", :tag =>"1.5.0"}
  s.vendored_frameworks = 'FQLPaySDK/FQLPay.framework,FQLPaySDK/MGFaceIDBaseKit.framework,FQLPaySDK/MGFaceIDIDCardKernelKit.framework,FQLPaySDK/MGFaceIDIDCardKit.framework,FQLPaySDK/MGFaceIDIDCardKit.framework'
  s.requires_arc = true
